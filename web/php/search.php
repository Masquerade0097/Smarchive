        ...
        <div class="container">
            ...
            <div class="dropdown button-dropdown">
                <a href="#pablo" class="dropdown-toggle" id="navbarDropdown" data-toggle="dropdown">
                    <img src="../assets/img/user/<?=$p_image?>" alt="..." id="daddy_image">
                </a>
    ...
    <footer class="footer footer-default">
        <div class="container">
            ...
            <div class="copyright">
                ...
                <a href="http://www.github.com/prabhakarpd7284/TopCoderHackathon" target="_blank">GitHub</a>
            </div>
        </div>
    </footer>
</div>
...
<script type="text/javascript">
    ...
    //    }
       ...
       $.ajax({
           ...
           data: {value: search_name, check1: check1, check2: check2,
