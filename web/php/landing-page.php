...
<nav class="navbar navbar-expand-lg bg-info">
    <div class="container">
        <a class="navbar-brand" href="#">Smarchive</a>
        ...
        <div class="collapse navbar-collapse" id="example-navbar-icons">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="search.php"><i class="now-ui-icons ui-1_zoom-bold" aria-hidden="true"></i></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="myproject.php">My Courses</a>
                    <?php if($profession=='faculty') echo '<a class="dropdown-item" href="addproject.php" >Add New Course</a>'; ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8" id="blog-container">
                    <div class="row">
                        <h3 class="title text-danger" text-align = "center"> <i class="now-ui-icons media-2_sound-wave"></i>Popular Courses</h3><br>
                        ...
                        <div class="row">
                            ...
                            --  ORDER BY blog.date DESC, blog.reads DESC LIMIT 2";
                            $result = mysqli_query($dbc, $query) or die ('Unable to query popular courses');
                ...
                <div id="sidebar">
                  <?php 
                            /* SCRIPT FOR my courses*/
                    // require('connect.php');
                    $query = "SELECT * FROM usercourse join course on usercourse.course_id=course.course_id WHERE 
                    username='$username' ORDER BY course.course_id DESC";
                    $result = mysqli_query($dbc, $query) or die ('Unable to query usercourse');
                    while($row = mysqli_fetch_array($result)){
                  ?>
