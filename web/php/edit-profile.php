<?php
    ...
    if(!isset($_SESSION['username'])){
        ...
        define('smarchive_UPLOADPATH', '../assets/img/');
        ...
        if(isset($_POST['submit'])){
            ...
            if(!is_dir(smarchive_UPLOADPATH."user"."/")) {
                mkdir(smarchive_UPLOADPATH."user"); 
            }
            $var = $profession."info";
            if($profession == 'student'){
            ...
            if($image!=''){
                ...
                if($old_image!='fb_avatar_male.jpg'){
                    $target = smarchive_UPLOADPATH.$username.'/'.$old_image;
                    @unlink($target);
                }*/
                $image1 = $username.'.jpg';
                ...
                $target = smarchive_UPLOADPATH.'user/'.$image1;
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a class="navbar-brand" href="landing-page.php"  data-placement="bottom" target="">
                    <img src="../assets/favicon/1.png" id="logo_id">
                </a>
            </div>
        ...
        <footer class="footer footer-default">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    <a href="http://www.github.com/SerChirag/smarchive" target="_blank">GitHub</a>
                </div>
            </div>
        </footer>
    </div>
