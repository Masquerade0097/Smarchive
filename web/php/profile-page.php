                        ...
                        <div class="card card-blog">
                            <div class="card-body">
                                <h6 class="category text-warning">
                                    <i class="now-ui-icons education_atom"></i> My Courses
                                </h6>
                                
                                <div class="card-footer text-center" style="background-color: white;">
                                    <a href="myproject.php?username=<?php echo $username; ?>" class="btn btn-default btn-round"><h4>My all Courses</h4></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="footer footer-default">
        <div class="container">
            ...
            <div class="copyright">
                ...
                <a href="https://github.com/prabhakarpd7284/TopCoderHackathon.git" target="_blank">GitHub</a>
            </div>
        </div>
    </footer>
</div>
