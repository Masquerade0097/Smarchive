...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `course`(`course_id`,`offeredby`, `title`, `description`,`url`)
    VALUES('$id','$username','$title','$desc','$image') ";
    //   echo $query;
    mysqli_query($dbc, $query)
    or die('Unable to addcourse');
    ...
    echo '<h1>Added course successfully.</p1><br><h3>You will be automatically redirected to the other page.</h3>';
    $url = "myproject.php";
            ...
            <div class="container">
                <form enctype="multipart/form-data" method="post" action= "addproject.php" >
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Course ID" name="id" />
                    </div>
                </div>
                        <div class="col-md-6">
        ...
        <footer class="footer footer-default">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    <a href="http://www.github.com/prabhakarpd7284/https://github.com/prabhakarpd7284/TopCoderHackathon" target="_blank">GitHub</a>
                </div>
            </div>
        </footer>
    </div>
